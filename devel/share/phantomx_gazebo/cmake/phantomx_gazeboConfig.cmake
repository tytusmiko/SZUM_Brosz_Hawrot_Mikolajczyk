...
if("TRUE" STREQUAL "TRUE")
  set(phantomx_gazebo_SOURCE_PREFIX /home/tytus/catkin_ws/src/phantomx_gazebo)
  set(phantomx_gazebo_DEVEL_PREFIX /home/tytus/catkin_ws/devel)
  ...
  set(phantomx_gazebo_INSTALL_PREFIX /home/tytus/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'phantomx_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/tytus/catkin_ws/src/phantomx_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT phantomx_gazebo_NUM_DUMMY_TARGETS)
      set(phantomx_gazebo_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::phantomx_gazebo::wrapped-linker-option${phantomx_gazebo_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR phantomx_gazebo_NUM_DUMMY_TARGETS "${phantomx_gazebo_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::phantomx_gazebo::wrapped-linker-option${phantomx_gazebo_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND phantomx_gazebo_LIBRARIES "${interface_target_name}")
